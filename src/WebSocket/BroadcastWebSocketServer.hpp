...
(中略 - ライセンスヘッダー / License header omitted for brevity)
*/
...
// Include your logger interface header
#include <ILogger.hpp> // Example: Replace with your actual logger header

// Include libusockets for us_listen_socket_close
