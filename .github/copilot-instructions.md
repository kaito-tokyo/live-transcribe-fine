# Development Guideline for Live Transcribe Fine
...
2. Run:
   ...
   rm -rf ~/Library/Application\ Support/obs-studio/plugins/live-transcribe-fine.plugin && \
   cp -r ./build_macos/RelWithDebInfo/live-transcribe-fine.plugin ~/Library/Application\ Support/obs-studio/plugins
   ```
...
2. Run:
   ...
   rm -rf ~/Library/Application\ Support/obs-studio/plugins/live-transcribe-fine.plugin && \
   cp -r ./build_homebrew/RelWithDebInfo/live-transcribe-fine.plugin ~/Library/Application\ Support/obs-studio/plugins
   ```
